...
import kr.co.vacatio.ylee.my_neighborhood_cats.manual.databinding.FragmentGuideBinding

class GuideFragment : Fragment() {
    private val binding by lazy { FragmentGuideBinding.inflate(layoutInflater) }
